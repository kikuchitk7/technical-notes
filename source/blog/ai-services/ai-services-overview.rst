...
今回の記事では全体感をつかむことを目的とし、個々の AI サービスの詳細や具体的な使い方については後続の連載で扱う予定です。
...
.. csv-table::
  :header: "サービス名", "サービスの特徴", "導入の難易度"
  :widths: 15, 10, 10
  
  "AI サービス", "AWS がユースケースごとに用意したサービスと自身の解決したい問題・課題とマッチする人向けのサービス。", "利用者が考える部分が少なくて済むため、「機械学習の深い知識なしに利用可能」であり、導入の難易度は最も低い"
